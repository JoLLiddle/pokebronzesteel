...
AuroreonPicFront::     INCBIN "gfx/pokemon/front/auroreon.pic"
AuroreonPicBack::      INCBIN "gfx/pokemon/back/auroreonb.pic"
RaichuPicFront::       INCBIN "gfx/pokemon/front/raichu.pic"
RaichuPicBack::        INCBIN "gfx/pokemon/back/raichub.pic"         ;This must be in the same bank as Raichu, Raikaenchu, mizuchu and kusachu
RaikaenchuPicFront::   INCBIN "gfx/pokemon/front/raikaenchu.pic"
RaikusachuPicFront::   INCBIN "gfx/pokemon/front/raikusachu.pic"
RaimizuchuPicFront::   INCBIN "gfx/pokemon/front/raimizuchu.pic"