...
Route4HS:
	db ROUTE_4, ROUTE4_TM_PURSUIT, SHOW
Route9HS:
	db ROUTE_9, ROUTE9_TM_TELEPORT, SHOW
Route12HS:
	db ROUTE_12, ROUTE12_SNORLAX,        SHOW
	db ROUTE_12, ROUTE12_TM_FLASHCANNON, SHOW
...
PokemonTower4FHS:
	db POKEMON_TOWER_4F, POKEMONTOWER4F_TM_DARK_PULSE,    SHOW
...
PokemonMansion3FHS:
	db POKEMON_MANSION_3F, POKEMONMANSION3F_TM_DAZZLE, SHOW
...
VermilionDockHS:
	db VERMILION_DOCK, VERMILIONDOCK_MEW_POKEBALL, SHOW
	db $FF, $01, SHOW ; end
