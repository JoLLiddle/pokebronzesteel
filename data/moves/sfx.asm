MoveSoundTable:
	...
	db SFX_BATTLE_26,          $00, $80 ; THUNDER_STEP (THUNDER)
	...
	db SFX_BATTLE_25,          $00, $10 ; METEOR_MASH (QUICK_ATTACK)
	...
	db SFX_SUPER_EFFECTIVE,    $f0, $ff ; DRAGON CLAW (CRABHAMMER)
  db SFX_BATTLE_25,          $00, $10 ; DRACOMETEOR (METEOR_MASH (QUICK_ATTACK))
